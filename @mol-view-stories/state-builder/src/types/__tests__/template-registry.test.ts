...
import { createTemplateRegistry, type TemplateRegistry } from '../template-registry';
import { BUILTIN_ADAPTER_ID, type TemplateAdapter } from '../template-adapter';
import type { TreeTemplate } from '../tree-templates';
