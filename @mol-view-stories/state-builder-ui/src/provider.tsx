...
import { StateChangeContext, type StateChangeFn } from './state/state-change-context';
import { StoryConstantsContext } from './state/story-constants-context';
  ...
  (
    {
      ...
      sceneInitialState, onStateChange,
