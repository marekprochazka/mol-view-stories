...
import { PRIMITIVE_KINDS } from '@mol-view-stories/state-builder/src';
import type { PrimitiveKind } from '@mol-view-stories/state-builder/src';
import type { PrimitiveKindFieldsProps } from './types';
import { AngleFields } from './AngleFields';
import { ArrowFields } from './ArrowFields';
import { BoxFields } from './BoxFields';
import { DistanceFields } from './DistanceFields';
import { EllipseFields } from './EllipseFields';
import { EllipsoidFields } from './EllipsoidFields';
import { LabelFields } from './LabelFields';
import { LinesFields } from './LinesFields';
import { MeshFields } from './MeshFields';
import { TubeFields } from './TubeFields';
